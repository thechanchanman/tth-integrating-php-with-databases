...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($error_message)) {
		...
		$mail->addAddress('giannis@localhost', 'Giannis');
				...
				<tr>
					...
					<td>
						<select id="format" name="format">
							...
							<optgroup label="Music"<?php if (isset($format) && $format == "Music") { echo " selected"; } ?>>
					...
					<td>
						<select name="genre" id="genre">
							...
							<optgroup label="Music">
								...
								<option value="Metal"<?php if (isset($genre) && $genre == "Metal") { echo " selected"; } ?>>Metal</option>
